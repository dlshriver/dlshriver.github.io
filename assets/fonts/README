...
Add the downloaded `icomoon.woff` file to this directory, encode it in base64 (e.g., `base64 icomoon.woff` on many unix-like systems), and replace the old base64 string with the updated string in the `_sass/fonts.scss` file.
